...
export default function Laporan() {
  ...
  const totalUtang = 0 // Diset 0 dulu karena belum ada fiturnya
  const totalModal = totalAset - totalUtang // Rumus: Harta = Utang + Modal
      ...
      return (
        <div className="space-y-4">
          <div className="bg-[#1B4F3A] rounded-2xl p-5 shadow-sm text-white print:border print:border-gray-300 print:bg-white print:text-black">
            <p className="text-white/70 print:text-gray-600 text-xs mb-1">Total Harta Warung (Aset)</p>
          ...
          <div className="bg-white rounded-2xl p-4 shadow-sm print:border print:border-gray-200">
            ...
            <div className="space-y-3">
              {[
                ...
                <div key={`neraca-${i}`} className={`flex justify-between items-center py-2 ${i < 2 ? 'border-b border-gray-100' : ''}`}>
          ...
          <div className="bg-white rounded-2xl p-4 shadow-sm print:border print:border-gray-200">
            <p className="text-sm font-bold text-red-500 mb-3 print:text-black">🛑 TITIPAN & UTANG (Liabilitas)</p>
            <div className="space-y-3">
              <div className="flex justify-between items-center py-2 border-b border-gray-100">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-gray-700 print:text-black">Titipan / Kembalian</p>
                    <p className="text-xs text-gray-400 print:text-gray-600">Dana titipan / kembalian pelanggan</p>
                  </div>
                </div>
                <p className="text-sm font-bold text-gray-700 print:text-black">Rp {totalUtang.toLocaleString('id-ID')}</p>
              </div>
              <div className="flex justify-between items-center bg-red-50 rounded-xl p-3 mt-2 print:bg-transparent print:border-t print:border-gray-300">
                ...
                <p className="text-sm font-bold text-red-500 print:text-black">Rp {totalUtang.toLocaleString('id-ID')}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl p-4 shadow-sm print:border print:border-gray-200">
            <p className="text-sm font-bold text-blue-500 mb-3 print:text-black">⚖️ MODAL (Ekuitas)</p>
            <div className="flex justify-between items-center bg-blue-50 rounded-xl p-3 print:bg-transparent print:border-t print:border-gray-300">
              <p className="text-sm font-bold text-gray-700 print:text-black">Total Modal Bersih</p>
              <p className="text-sm font-bold text-blue-600 print:text-black">Rp {totalModal.toLocaleString('id-ID')}</p>
            </div>
            <p className="text-[10px] text-gray-400 mt-2 text-center print:hidden">*Berdasarkan rumus persamaan dasar: Harta = Utang + Modal</p>
          </div>
  ...
  return (
    <main className="min-h-screen bg-gray-100 pb-24 print:bg-white print:pb-0">
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-100 px-6 py-3 flex justify-around items-center print:hidden">
        ...
        <Link href="/laporan" className="flex flex-col items-center text-[#1B4F3A]">
