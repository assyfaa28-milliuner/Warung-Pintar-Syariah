    ...
    <main className="min-h-screen bg-gray-100 pb-24">
          ...
          <>
            ...
            {editing ? (
              <div className="bg-white rounded-2xl p-5 shadow-sm space-y-4">
                <p className="text-sm font-bold text-gray-500">Edit Profile</p>
            ...
            {showChangePIN ? (
              <div className="bg-white rounded-2xl p-5 shadow-sm space-y-4 border border-blue-200">
                ...
                <div>
                  ...
                  <input type="password" inputMode="numeric" maxLength={6} value={oldPin} onChange={(e) => setOldPin(e.target.value.slice(0, 6))} className="w-full bg-gray-50 rounded-xl px-4 py-3 border border-gray-200 text-center text-lg tracking-widest focus:outline-none focus:ring-2 focus:ring-[#1B4F3A]" placeholder="••••••" />
                </div>
                <div>
                  <label className="block text-sm text-gray-500 mb-2">PIN Baru (6 digit)</label>
                  <input type="password" inputMode="numeric" maxLength={6} value={newPin} onChange={(e) => setNewPin(e.target.value.slice(0, 6))} className="w-full bg-gray-50 rounded-xl px-4 py-3 border border-gray-200 text-center text-lg tracking-widest focus:outline-none focus:ring-2 focus:ring-[#1B4F3A]" placeholder="••••••" />
                </div>
                <div>
                  <label className="block text-sm text-gray-500 mb-2">Ulangi PIN Baru</label>
                  <input type="password" inputMode="numeric" maxLength={6} value={confirmPin} onChange={(e) => setConfirmPin(e.target.value.slice(0, 6))} className="w-full bg-gray-50 rounded-xl px-4 py-3 border border-gray-200 text-center text-lg tracking-widest focus:outline-none focus:ring-2 focus:ring-[#1B4F3A]" placeholder="••••••" />
                </div>
                <div className="flex gap-2">
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-100 px-6 py-3 flex justify-around items-center">
        ...
        <a href="/warpin-ai" className="flex flex-col items-center">
          ...
          <span className="text-xs mt-0.5">Warpin AI</span>
        </a>
